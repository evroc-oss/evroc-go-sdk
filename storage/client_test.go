...
func TestClient(t *testing.T) {
	...
	if _, err := client.Buckets().Patch(ctx, "test", &storage.Bucket{ApiVersion: builderAPIVersion, Kind: "Bucket"}); err != nil {
	...
	if _, err := client.BucketServiceAccounts().Patch(ctx, "test", &storage.BucketServiceAccount{ApiVersion: builderAPIVersion, Kind: "BucketServiceAccount"}); err != nil {
