...
const (
	defaultAuthURL  = "https://authn.cloud.evroc.com/realms/evroc-customer/protocol/openid-connect/auth"
	defaultTokenURL = "https://authn.cloud.evroc.com/realms/evroc-customer/protocol/openid-connect/token"
