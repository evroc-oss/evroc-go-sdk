...
// GetStorageV1ProjectsProjectIDRegionsRegionNameBucketsParams defines parameters for GetStorageV1ProjectsProjectIDRegionsRegionNameBuckets.
type GetStorageV1ProjectsProjectIDRegionsRegionNameBucketsParams struct {
	// LabelSelector Optional label selector to select resources using Kubernetes-style selector syntax. This can be used with label keys from userLabels and systemLabels, using the prefixed syntax (e.g. "team in (frontend,backend)", "networking.evroc.com/managed-network=default").
	LabelSelector *string `form:"labelSelector,omitempty" json:"labelSelector,omitempty"`
}
...
// PutStorageV1ProjectsProjectIDRegionsRegionNameBucketServiceAccountsBucketServiceAccountIDJSONRequestBody defines body for PutStorageV1ProjectsProjectIDRegionsRegionNameBucketServiceAccountsBucketServiceAccountID for application/json ContentType.
type PutStorageV1ProjectsProjectIDRegionsRegionNameBucketServiceAccountsBucketServiceAccountIDJSONRequestBody = BucketServiceAccountRequest
...
// PutStorageV1ProjectsProjectIDRegionsRegionNameBucketsBucketIDJSONRequestBody defines body for PutStorageV1ProjectsProjectIDRegionsRegionNameBucketsBucketID for application/json ContentType.
type PutStorageV1ProjectsProjectIDRegionsRegionNameBucketsBucketIDJSONRequestBody = BucketRequest
