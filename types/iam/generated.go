...
type Organization struct {
	...
	Metadata struct {
		...
		// Name Unique identifier for the organization. Immutable.
		Name *openapi_types.UUID `json:"name,omitempty"`
...
type OrganizationSpec struct {
	// DisplayName Human-friendly name for the resource. Mutable. Not required to be unique.
...
type ProjectSpec struct {
	...
	// Organization Organization is the name of the Organization resource this project belongs to.
...
// GetIamV1alpha4ProjectsProjectNamePermissionSetsParams defines parameters for GetIamV1alpha4ProjectsProjectNamePermissionSets.
type GetIamV1alpha4ProjectsProjectNamePermissionSetsParams struct {
...
// PatchIamV1alpha4OrganizationsOrganizationNameJSONRequestBody defines body for PatchIamV1alpha4OrganizationsOrganizationName for application/json ContentType.
type PatchIamV1alpha4OrganizationsOrganizationNameJSONRequestBody = OrganizationRequest

// PostIamV1alpha4ProjectsJSONRequestBody defines body for PostIamV1alpha4Projects for application/json ContentType.
type PostIamV1alpha4ProjectsJSONRequestBody = ProjectRequest

// PatchIamV1alpha4ProjectsProjectNameJSONRequestBody defines body for PatchIamV1alpha4ProjectsProjectName for application/json ContentType.
type PatchIamV1alpha4ProjectsProjectNameJSONRequestBody = ProjectRequest

// PutIamV1alpha4ProjectsProjectNameJSONRequestBody defines body for PutIamV1alpha4ProjectsProjectName for application/json ContentType.
type PutIamV1alpha4ProjectsProjectNameJSONRequestBody = ProjectRequest

// PostIamV1alpha4ProjectsProjectNamePermissionSetsJSONRequestBody defines body for PostIamV1alpha4ProjectsProjectNamePermissionSets for application/json ContentType.
type PostIamV1alpha4ProjectsProjectNamePermissionSetsJSONRequestBody = PermissionSetRequest

// PatchIamV1alpha4ProjectsProjectNamePermissionSetsPermissionSetNameJSONRequestBody defines body for PatchIamV1alpha4ProjectsProjectNamePermissionSetsPermissionSetName for application/json ContentType.
type PatchIamV1alpha4ProjectsProjectNamePermissionSetsPermissionSetNameJSONRequestBody = PermissionSetRequest

// PutIamV1alpha4ProjectsProjectNamePermissionSetsPermissionSetNameJSONRequestBody defines body for PutIamV1alpha4ProjectsProjectNamePermissionSetsPermissionSetName for application/json ContentType.
type PutIamV1alpha4ProjectsProjectNamePermissionSetsPermissionSetNameJSONRequestBody = PermissionSetRequest
