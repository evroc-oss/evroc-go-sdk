...
func (c *Config) SetDefaults() {
	...
	if c.Auth.ClientID == "" {
		c.Auth.ClientID = "evroc-cli"
	}

	// Set default token_url if not specified
	if c.Auth.TokenURL == "" {
		c.Auth.TokenURL = "https://authn.cloud.evroc.com/realms/evroc-customer/protocol/openid-connect/token"
	}
	...
	if c.API.BaseURL == "" {
		c.API.BaseURL = "https://api.cloud.evroc.com"
	}
}
