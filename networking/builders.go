...
// The sgRef should be a short ID; it will be resolved to a fully qualified ID.
...
// The subnetRef should be a short ID; it will be resolved to a fully qualified ID.
